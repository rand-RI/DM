...
Table_1= srm.MahalanobisDist_Table1(Returns=Table_1_returns)[0]
Table_2=srm. MahalanobisDist_Table2(returns, Mahalanobis_Distance_Returns=srm.MahalanobisDist(Returns=returns))#Need to change Returns= Table_2 returns
