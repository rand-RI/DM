...
MSCIUS_PRICES= pd.load('MSCIUSA')                                              #MSCI US Index daily prices
    ...
    #Mahalanobis Distance
SRM_mahalanobis= md.MahalanobisDist(Returns=returns)                          #Import Mahalanobis Distance Formula given the input of returns
Table_1= md.MahalanobisDist_Table1(Returns=Table_1_returns)[0]                #Import Table 2 data
Table_2=md.MahalanobisDist_Table2(Returns=returns, Mahalanobis_Distance_Returns=md.MahalanobisDist(Returns=returns))#Need to change Returns= Table_2 returns

    #Correlation Surprise
SRM_correlationsurprise= cs.Correlation_Surprise(Returns=returns)             #define Correlation Surprise Score
Correlation_Surprise_Exhibit_5= cs.Correlation_Surprise_Table_Exhbit5(Exhibit5_USEquities, Exhibit5_Euro_Equities, Exhibit5_Currency) # Import Exhibit 5
